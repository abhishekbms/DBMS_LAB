...
create table accident(report_num varchar(20),accident date,location varchar(20),primary key (report_num)); 
...
create table participated(driver_id varchar(20),reg_num varchar(20),report_num varchar(20),damage_amount int,primary key(driver_id,reg_num,report_num),foreign key(driver_id)references person(driver_id),foreign key(reg_num)references car(reg_num),foreign key(report_num)references accident(report_num));
