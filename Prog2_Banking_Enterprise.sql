...
create table BankAccount(acc_num int,branch_name varchar(30),balance real,primary key(acc_num),foreign key(branch_name) references Branch(branch_name));
...
create table Depositer(customer_name varchar(30),acc_num int,primary key(customer_name,acc_num),foreign key(customer_name) references BankCustomer(customer_name),foreign key(acc_num) references BankAccount(acc_num));
